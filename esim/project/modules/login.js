...
app.post("/", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var _a, username, password, query, values, result, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                query = "select * from users where userid = $1 and password = $2";
            ...
            case 2:
                ...
                if (result.rows.length == 1) {
                    ...
                    return [2 /*return*/, res.status(401).json({ message: "Login failed" })];
                }
                return [3 /*break*/, 4];
            case 3:
                err_1 = _b.sent();
